...
namespace log_level {
  ...
  static constexpr auto ENCODER_DATA = LOG_LEVEL::BYTE;
...
namespace settings {
  ...
  static const std::vector<std::vector<enum CELL_DATA_ORDER>> save_data_order = {
    {CELL_DATA_ORDER::d1,CELL_DATA_ORDER::d2,CELL_DATA_ORDER::ordinary_first_byte,CELL_DATA_ORDER::cell_refs,CELL_DATA_ORDER::flush_byte,},
    {CELL_DATA_ORDER::special_cell_type,},
