...
protected:
	void set_data(const distribution_data& data) {
		...
		while (sorted_vertex.size() > 1) {
			...
			sorted_vertex.pop();
			for (auto x : v1) add_bit(x, 1);
			for (auto x : v2) add_bit(x, 0);
...
{"special_d2",{{14507,72},{84,66},{25,138},{6,70},{0,255},{0,254},{0,253},{0,252},{0,251},{0,250},{0,249},{0,248},{0,247},{0,246},{0,245},{0,244},{0,243},{0,242},{0,241},{0,240},{0,239},{0,238},{0,237},{0,236},{0,235},{0,234},{0,233},{0,232},{0,231},{0,230},{0,229},{0,228},{0,227},{0,226},{0,225},{0,224},{0,223},{0,222},{0,221},{0,220},{0,219},{0,218},{0,217},{0,216},{0,215},{0,214},{0,213},{0,212},{0,211},{0,210},{0,209},{0,208},{0,207},{0,206},{0,205},{0,204},{0,203},{0,202},{0,201},{0,200},{0,199},{0,198},{0,197},{0,196},{0,195},{0,194},{0,193},{0,192},{0,191},{0,190},{0,189},{0,188},{0,187},{0,186},{0,185},{0,184},{0,183},{0,182},{0,181},{0,180},{0,179},{0,178},{0,177},{0,176},{0,175},{0,174},{0,173},{0,172},{0,171},{0,170},{0,169},{0,168},{0,167},{0,166},{0,165},{0,164},{0,163},{0,162},{0,161},{0,160},{0,159},{0,158},{0,157},{0,156},{0,155},{0,154},{0,153},{0,152},{0,151},{0,150},{0,149},{0,148},{0,147},{0,146},{0,145},{0,144},{0,143},{0,142},{0,141},{0,140},{0,139},{0,137},{0,136},{0,135},{0,134},{0,133},{0,132},{0,131},{0,130},{0,129},{0,128},{0,127},{0,126},{0,125},{0,124},{0,123},{0,122},{0,121},{0,120},{0,119},{0,118},{0,117},{0,116},{0,115},{0,114},{0,113},{0,112},{0,111},{0,110},{0,109},{0,108},{0,107},{0,106},{0,105},{0,104},{0,103},{0,102},{0,101},{0,100},{0,99},{0,98},{0,97},{0,96},{0,95},{0,94},{0,93},{0,92},{0,91},{0,90},{0,89},{0,88},{0,87},{0,86},{0,85},{0,84},{0,83},{0,82},{0,81},{0,80},{0,79},{0,78},{0,77},{0,76},{0,75},{0,74},{0,73},{0,71},{0,69},{0,68},{0,67},{0,65},{0,64},{0,63},{0,62},{0,61},{0,60},{0,59},{0,58},{0,57},{0,56},{0,55},{0,54},{0,53},{0,52},{0,51},{0,50},{0,49},{0,48},{0,47},{0,46},{0,45},{0,44},{0,43},{0,42},{0,41},{0,40},{0,39},{0,38},{0,37},{0,36},{0,35},{0,34},{0,33},{0,32},{0,31},{0,30},{0,29},{0,28},{0,27},{0,26},{0,25},{0,24},{0,23},{0,22},{0,21},{0,20},{0,19},{0,18},{0,17},{0,16},{0,15},{0,14},{0,13},{0,12},{0,11},{0,10},{0,9},{0,8},{0,7},{0,6},{0,5},{0,4},{0,3},{0,2},{0,1},{0,0}}},
...
struct LoadCellData {
	...
	td::Status init_offsets() {
		...
		if (special) {
			...
			uncompressed_data_offset = 1 + int(ordinary_first_byte == 0 && full_data_len >= 2);
			uncompressed_data_len = full_data_len - uncompressed_data_offset;
		}
		return td::Status::OK();
	}
	...
	td::Status set_ordinary_first_byte(int byte) {
		TRY_STATUS(init_data());
		if (special || full_data_len < 1) return td::Status::OK();
		data[0] = ordinary_first_byte = byte;
		DBG(log_level::CELL_META, ordinary_first_byte);
		return td::Status::OK();
	}
	td::Status set_ordinary_second_byte_0(int byte) {
		TRY_STATUS(init_data());
		if (special || full_data_len < 2 || ordinary_first_byte != 0) return td::Status::OK();
		data[1] = ordinary_second_byte_0 = byte;
		DBG(log_level::CELL_META, ordinary_second_byte_0);
		return td::Status::OK();
	}
	...
	int compare_meta(const LoadCellData& other) const {
		...
		// if (ordinary_second_byte_0 != other.ordinary_second_byte_0) {
		// 	return ordinary_second_byte_0 < other.ordinary_second_byte_0 ? -1 : 1;
		// }
...
td::Result<std::size_t> CustomBagOfCells::serialize_to_impl(WriterT& writer) {
	...
	for (int i = cell_count - 1; i >= 0; --i) {
		...
		if (cell_info[i].special) {
			...
			if (s >= 3 && cell_info[i].ordinary_first_byte == 0) {
				cell_info[i].set_ordinary_second_byte_0(uint32_t(buf[3]));
			}
		}
		for (int x = 2; x < s; ++x) {
				...
				for (auto mode : stored_fields) {
					switch (mode) {
						...
						case settings::cell_data_order::D2: {
							...
							add_char("d2", d2);
							if (!cell_info[i].special) {
								add_char("ordinary_d2", d2);
							} else {
								add_char("special_d2", d2);
							}
							if (cell_info[i].special) {
								huffman::special_d2.write(buffer_bwriter, d2);
							} else {
								huffman::ordinary_d2.write(buffer_bwriter, d2);
							}
							break;
						}
						...
						case settings::cell_data_order::ORDINARY_FIRST_BYTE: {
							if (cell_info[i].special || cell_info[i].full_data_len < 1) continue;
...
td::Result<long long> CustomBagOfCells::deserialize(const td::Slice& data, int max_roots) {
					...
					switch (mode) {
						...
						case settings::cell_data_order::D2: {
							...
							if (cell_info.special) {
								cell_info.d2 = huffman::special_d2.read(buffer_breader);
							} else {
								cell_info.d2 = huffman::ordinary_d2.read(buffer_breader);
							}
							break;
						}
						case settings::cell_data_order::SPECIAL_CELL_TYPE: {
						...
						case settings::cell_data_order::ORDINARY_FIRST_BYTE: {
							...
							if (cell_info.special || cell_info.full_data_len < 1) continue;
						...
						case settings::cell_data_order::ORDINARY_SECOND_BYTE_0: {
							TRY_STATUS(cell_info.init());
							if (cell_info.special || cell_info.ordinary_first_byte != 0 || cell_info.full_data_len < 2) continue;
							int second_byte = huffman::ordinary_second_byte_0.read(buffer_breader);
							cell_info.ordinary_second_byte_0 = second_byte;
							break;
						}
						case settings::cell_data_order::FLUSH_BYTE: {
	...
	for (int i = 0; i < cell_count; i++) {
		...
		cell_info.set_ordinary_second_byte_0(cell_info.ordinary_second_byte_0);
